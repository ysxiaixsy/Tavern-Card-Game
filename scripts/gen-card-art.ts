 ...
 *
 * The output is committed EMPTY by default; after running this, mark it
 * skip-worktree so your local (private) art map isn't committed:
 *   git update-index --skip-worktree src/ui/cardArt.ts
 */
...
writeFileSync(
  ...
  `/* GENERATED by npm run gen:art — do NOT commit if assets/cards is gitignored.\n` +
    ` * defId -> bundled card image; unmatched cards use the programmatic frame. */\n` +
